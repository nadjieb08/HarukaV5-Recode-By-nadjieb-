...
nocache('./command/case.js', module => console.log(`${module} diawasi kalo di ganti!`))

const starts = async (haruka = new WAConnection()) => {
    haruka.logger.level = 'warn'
    haruka.version = [2, 2143, 3]
    haruka.browserDescription = [ 'nadjiebBotz', 'Chrome', '3.0' ]
	CFonts.say('nadjiebBotz', {
		font: 'block',
    	color: ['#ff9c00'],
    	align: 'center',
		})
	CFonts.say(`Bot WhatsApp Recode By nadjieb`, {
		font: 'console',
		align: 'center',
